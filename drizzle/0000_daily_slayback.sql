...
ALTER TABLE "buyers" ADD CONSTRAINT "buyers_entity_id_entities_id_fk" FOREIGN KEY ("entity_id") REFERENCES "public"."entities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "buyers_name_unique" ON "buyers" USING btree ("name");--> statement-breakpoint
CREATE INDEX "buyers_entity_idx" ON "buyers" USING btree ("entity_id");--> statement-breakpoint
CREATE INDEX "buyers_status_idx" ON "buyers" USING btree ("match_status");--> statement-breakpoint
...
CREATE INDEX "councils_parent_entity_idx" ON "councils" USING btree ("parent_entity_id");--> statement-breakpoint
...
CREATE INDEX "spend_entries_buyer_payment_idx" ON "spend_entries" USING btree ("buyer_id","payment_date");--> statement-breakpoint
